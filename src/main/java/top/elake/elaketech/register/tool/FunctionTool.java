...
public class FunctionTool {
     ...
     * 一级探测器 - 只显示粒子
     */
    public static final ItemEntry<MetalDetector> METAL_DETECTOR = REGISTRATE.item("metal_detector", MetalDetector::new)
     ...
     * 二级探测器 - 显示矿物名称
     */
    public static final ItemEntry<MetalDetectorT2> METAL_DETECTOR_T2 = REGISTRATE.item("metal_detector_t2", MetalDetectorT2::new)
     ...
     * 三级探测器 - 显示矿物名称和坐标
     */
    public static final ItemEntry<MetalDetectorT3> METAL_DETECTOR_T3 = REGISTRATE.item("metal_detector_t3", MetalDetectorT3::new)
