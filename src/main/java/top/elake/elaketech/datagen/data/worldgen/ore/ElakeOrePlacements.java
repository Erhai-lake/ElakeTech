 ...
 * @author Elake Studio
 */
public class ElakeOrePlacements {
    public static final ResourceKey<PlacedFeature> ORE_GRAPHITE = createKey("graphite_ore");
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        // 石墨
        Holder<ConfiguredFeature<?, ?>> oreGraphiteHolder = holdergetter.getOrThrow(ElakeOreFeatures.ORE_GRAPHITE);
