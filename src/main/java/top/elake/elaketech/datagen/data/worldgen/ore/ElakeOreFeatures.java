...
public class ElakeOreFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> list = List.of(
                ...
                OreConfiguration.target(deepSlateOreReplaceRuleGraphite, OreBlock.DEEP_GRAPHITE.get().defaultBlockState())
        );
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> createKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ElakeTech.loadResource(name));
    }
}