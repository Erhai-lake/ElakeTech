...
public class Registers {
     ...
     * @return 工具句柄
     */
    public static ItemEntry<? extends Item> addAloneTool(String id, String name, String type, Tier tier, Item.Properties properties, int craftingDamage, String texture) {
        return switch (type) {
            case "sword" -> REGISTRATE.<SwordDamageToolCrafting>item(id,
                            (p) -> new SwordDamageToolCrafting(tier, properties, craftingDamage))
                    .model((c, p) -> p.generated(c, p.modLoc(texture)))
                    .lang(name)
                    .register();
            case "pickaxe" -> REGISTRATE.<PickaxeDamageToolCrafting>item(id,
                            (p) -> new PickaxeDamageToolCrafting(tier, properties, craftingDamage))
                    .model((c, p) -> p.generated(c, p.modLoc(texture)))
                    .lang(name)
                    .register();
            case "axe" -> REGISTRATE.<AxeDamageToolCrafting>item(id,
                            (p) -> new AxeDamageToolCrafting(tier, properties, craftingDamage))
                    .model((c, p) -> p.generated(c, p.modLoc(texture)))
                    .lang(name)
                    .register();
            case "shovel" -> REGISTRATE.<ShovelDamageToolCrafting>item(id,
                            (p) -> new ShovelDamageToolCrafting(tier, properties, craftingDamage))
                    .model((c, p) -> p.generated(c, p.modLoc(texture)))
                    .lang(name)
                    .register();
            case "hoe" -> REGISTRATE.<HoeDamageToolCrafting>item(id,
                            (p) -> new HoeDamageToolCrafting(tier, properties, craftingDamage))
                    .model((c, p) -> p.generated(c, p.modLoc(texture)))
                    .lang(name)
                    .register();
            case "hammer" -> REGISTRATE.<HammerDamageToolCrafting>item(id,
    ...
    public static ItemEntry<? extends Item> addColorTool(String id, String name, int color, String type, Tier tier, Item.Properties properties, int craftingDamage) {
        return switch (type) {
            case "sword" -> REGISTRATE.<SwordDamageToolCrafting>item(id,
                            (p) -> new SwordDamageToolCrafting(tier, properties, craftingDamage))
                    .model((c, p) -> {
